...
using StudentInformationProjectDatabaseFirst.Model;

namespace StudentInformationProjectDatabaseFirst.Controllers
{
    ...
    public class StudentDetailsController : ControllerBase
    {
        ...
        public StudentDetailsController(StudentDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<StudentDetail>> PostStudentDetail(StudentDetail studentDetail)
        {
          if (_context.StudentDetails == null)
          {
              return Problem("Entity set 'StudentDatabaseContext.StudentDetails'  is null.");
          }
